module.exports = async (context) => {
  ...
  try {
    ...
    const response = await fetch("https://api.github.com/repos/CYBER-XcyberX/CYBER-X");
    ...
    if (repoData) {
      ...
      const messageText = `
        *A Total of ${modifiedForks} People are using CYBER-X.*
        
        *${modifiedStars} People have starred it as a sign of Loving it.*
        
        *KEEP USING CYBER-X*
        
        *Regards, CYBER-XcyberX*
      `;
