...
module.exports = async (context) => {
  await ownerMiddleware(context, async () => {
    ...
    try {
      ...
      const { data } = await axios.get('https://api.github.com/repos/CYBER-XcyberX/CYBER-X/commits/main');
      ...
      if (commitHash === currentCommitHash) {
        sendReply(client, m, 'You are using the latest version of CYBER-X MD');
      } else {
        sendReply(
          client,
          m,
